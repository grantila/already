...
export declare type MapArray<T> = Array<T | PromiseLike<T>> | ReadonlyArray<T | PromiseLike<T>>;
export declare type MapFn<T, U> = (t: T, index: number, arr: MapArray<T>) => U | Promise<U>;
export declare type FilterFn<T> = MapFn<T, boolean>;
export declare function filter<T>(filterFn: FilterFn<T>): (t: ReadonlyArray<T | PromiseLike<T>>) => Promise<Array<T>>;
export declare function filter<T>(opts: FilterMapOptions, filterFn: FilterFn<T>): (t: ReadonlyArray<T | PromiseLike<T>>) => Promise<Array<T>>;
export declare function filter<T>(arr: ReadonlyArray<T | PromiseLike<T>>, filterFn: FilterFn<T>): Promise<Array<T>>;
export declare function filter<T>(arr: ReadonlyArray<T | PromiseLike<T>>, opts: FilterMapOptions, filterFn: FilterFn<T>): Promise<Array<T>>;
export declare function map<T, U>(mapFn: MapFn<T, U>): (t: ReadonlyArray<T | PromiseLike<T>>) => Promise<Array<U>>;
export declare function map<T, U>(opts: FilterMapOptions, mapFn: MapFn<T, U>): (t: ReadonlyArray<T | PromiseLike<T>>) => Promise<Array<U>>;
export declare function map<T, U>(arr: ReadonlyArray<T | PromiseLike<T>>, mapFn: MapFn<T, U>): Promise<Array<U>>;
export declare function map<T, U>(arr: ReadonlyArray<T | PromiseLike<T>>, opts: FilterMapOptions, mapFn: MapFn<T, U>): Promise<Array<U>>;
...
export declare function specific<T, U extends Promise<T>>(filters: CatchFilter | Array<CatchFilter> | null, handler: (err: Error) => U): (err: Error) => (U);
export declare function specific<T>(filters: CatchFilter | Array<CatchFilter> | null, handler: (err: Error) => T): (err: Error) => (T | Promise<T>);
